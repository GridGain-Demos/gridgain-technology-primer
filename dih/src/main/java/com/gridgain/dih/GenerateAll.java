...
import com.gridgain.dih.replicate.CassandraMetadata;
import com.gridgain.dih.replicate.DB;
import com.gridgain.dih.replicate.JdbcMetadata;
import com.gridgain.dih.replicate.Metadata;
import com.gridgain.dih.replicate.MongoDBMetadata;
import com.gridgain.dih.replicate.MySqlMetadata;
import com.gridgain.dih.replicate.PostgresMetadata;
import com.gridgain.dih.replicate.Table;
	...
	public void run() throws Exception {
		...
		for (Metadata metadata : metadatas) {
			...
			for (Table table : dbTables) {
				...
				if (metadata instanceof JdbcMetadata) {
					root.put("throwssqlexception", ((JdbcMetadata) metadata).throwsSqlException());
				}
